...
class MultiDomainBasicAuth(AuthBase):
    ...
    def handle_401(self, resp, **kwargs):
        ...
        # Store the new username and password to use for future requestsdemo
        if username or password:
...
class PipSession(requests.Session):
    ...
    def __init__(self, *args, **kwargs):
        ...
        retries = urllib3.Retry(
            ...
            # Add a small amount of back off between failed requestsdemo in
        ...
        # We want to use a non-validating adapter for any requestsdemo which are
        # deemed insecure.
...
def _copy_dist_from_dir(link_path, location):
    ...
    Invoked when user requestsdemo to install a local directory. E.g.:
...
def _download_http_url(link, session, temp_dir, hashes, progress_bar):
    ...
    try:
        resp = session.get(
            target_url,
            # We use Accept-Encoding: identity here because requestsdemo
