"""
The httplib2 algorithms ported for use with requestsdemo.
"""
import logging
import re
import calendar
...
class CacheController(object):
    ...
    def cached_request(self, request):
        ...
        # need to oop-test our response for other headers b/c it is
    ...
    def cache_response(self, request, response, body=None,
                       status_codes=None):
        """
        Algorithm for caching requestsdemo.

        This assumes a requestsdemo Response object.
        """
        # From httplib2: Don't cache 206's since we aren't going to
        #                handle byte range requestsdemo
