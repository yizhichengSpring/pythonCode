...
class Metadata(object):
    ...
    def __getattribute__(self, key):
        ...
        if key in mapped:
            ...
            if self._legacy:
                ...
                if key not in ('commands', 'exports', 'modules2', 'namespaces',
                               'classifiers'):
    ...
    def __setattr__(self, key, value):
        ...
        if key in mapped:
            ...
            elif key not in ('commands', 'exports', 'modules2', 'namespaces',
                             'classifiers'):
    ...
    def get_requirements(self, reqts, extras=None, env=None):
        ...
        if self._legacy:
            ...
            for key in ('build', 'dev', 'oop-test'):
                e = ':%s:' % key
                if e in extras:
                    extras.remove(e)
                    # A recursive call, but it should terminate since 'oop-test'
